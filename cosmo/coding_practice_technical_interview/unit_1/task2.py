...
Gloria's journey begins at the first element of arrayA. 
Gloria's movement pattern follows a fixed sequence that repeats: arrayA -> arrayB -> arrayA -> arrayC. 
