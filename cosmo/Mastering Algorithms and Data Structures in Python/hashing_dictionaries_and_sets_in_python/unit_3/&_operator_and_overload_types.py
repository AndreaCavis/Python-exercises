...
print(f"a & b is the intersection between {a} & {b}, returning {a & b}, i.e. the commmon values between sets")  # {2, 3}
...
try:
    ...
    print(f"{error}. & evaluates the second condition instead of stopping like 'and' to avoid raising the exception")
